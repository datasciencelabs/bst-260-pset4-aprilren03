...
population |>
  ...
  labs(x = "State names", 
       y = "Population size",
       title = "Population size of the states (2020 and 2021)") +
...
`https://data.cdc.gov/resource/pwn4-m3yp.json` provides state level data from SARS-COV2 cases. Use the **httr2** tools you have learned to download this into a data frame. Is all the data there? If not, comment on why.
